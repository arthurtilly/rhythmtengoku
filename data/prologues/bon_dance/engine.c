...
extern const Palette bon_odori_prologue_bg_pal[];
extern const Palette bon_odori_prologue_obj_pal[];
...
const struct CompressedGraphics *const bon_dance_prologue_buffered_textures[] = {
    END_OF_BUFFERED_TEXTURES_LIST
};

// [D_089ea518] Graphics Table
const struct GraphicsTable bon_dance_prologue_gfx_table[] = {
    /* BG Tileset */ {
        /* Src.  */ &D_08be854c,
...
const EngineEvent bon_dance_prologue_engine_events[] = {
