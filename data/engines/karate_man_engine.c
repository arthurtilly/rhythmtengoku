...
const EngineEvent karate_common_events[] = {
    /* BEAT_ANIMATION */ (EngineEvent) func_08021f04,
    /* DISPLAY_TEXT   */ (EngineEvent) func_08022010,
    /* INIT_TUTORIAL  */ (EngineEvent) func_080214a0,
    END_OF_COMMON_EVENT_LIST
};

// [D_089df020] Engine Events
const EngineEvent karate_engine_events[] = {
    /* 0x00 */ (EngineEvent) func_080213d4,
    /* 0x01 */ (EngineEvent) func_08021408,
    /* 0x02 */ (EngineEvent) func_08021424,
    /* 0x03 */ (EngineEvent) func_08021440,
    /* 0x04 */ (EngineEvent) func_08021458,
    /* 0x05 */ (EngineEvent) func_0802221c,
    /* 0x06 */ (EngineEvent) func_080214d4,
    /* 0x07 */ (EngineEvent) func_08021524,
    /* 0x08 */ (EngineEvent) func_08021544
};

// [D_089df044] Karate Man Game Engine
const struct GameEngine D_089df044 = {
    /* Size in Memory */ sizeof(struct KarateManInfo),
    /* Init. Engine   */ karate_engine_init,
...
const struct CueDefinition karate_cue_pot = {
    ...
    /* Func. Spawn     */ func_08021644,
    /* Spawn Parameter */ KARATE_OBJECT_POT,
    /* Func. Update    */ func_08021888,
    /* Func. Despawn   */ func_08021974,
    /* Func. Hit       */ func_08021a60,
    /* Func. Barely    */ func_08021d38,
    /* Func. Miss      */ func_08021dcc,
