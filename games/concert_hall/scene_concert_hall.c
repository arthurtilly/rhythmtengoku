...
extern struct Beatscript script_concert_hall_entry[];

struct SubScene subscene_concert_hall = {
    ...
    /* End Param */        NULL,
    /* Beatscript Entry */ script_concert_hall_entry
};

struct Scene scene_concert_hall = {
    /* Init Func */  func_0801d86c,
    /* Init Param */ &subscene_concert_hall,
