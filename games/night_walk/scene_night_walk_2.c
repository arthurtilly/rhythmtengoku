...
extern struct Beatscript script_night_walk_2_entry[];

struct SubScene subscene_night_walk_2 = {
    ...
    /* End Param */        NULL,
    /* Beatscript Entry */ script_night_walk_2_entry
};

struct Scene scene_night_walk_2 = {
    /* Init Func */  func_0801d86c,
    /* Init Param */ &subscene_night_walk_2,
