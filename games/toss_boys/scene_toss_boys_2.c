...
extern struct Beatscript script_toss_boys_2_entry[];

struct SubScene subscene_toss_boys_2 = {
    ...
    /* End Param */        NULL,
    /* Beatscript Entry */ script_toss_boys_2_entry
};

struct Scene scene_toss_boys_2 = {
    /* Init Func */  func_0801d86c,
    /* Init Param */ &subscene_toss_boys_2,
