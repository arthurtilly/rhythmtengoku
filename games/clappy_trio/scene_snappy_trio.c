...
extern struct Beatscript script_snappy_trio_entry[];

struct SubScene subscene_snappy_trio = {
    ...
    /* End Param */        NULL,
    /* Beatscript Entry */ script_snappy_trio_entry
};

struct Scene scene_snappy_trio = {
    /* Init Func */  func_0801d86c,
    /* Init Param */ &subscene_snappy_trio,
