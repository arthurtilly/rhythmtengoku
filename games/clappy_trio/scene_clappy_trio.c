...
extern struct Beatscript script_clappy_trio_entry[];

struct SubScene subscene_clappy_trio = {
    ...
    /* End Param */        NULL,
    /* Beatscript Entry */ script_clappy_trio_entry
};

struct Scene scene_clappy_trio = {
    /* Init Func */  func_0801d86c,
    /* Init Param */ &subscene_clappy_trio,
