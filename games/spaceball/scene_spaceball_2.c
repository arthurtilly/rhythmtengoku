...
extern struct Beatscript script_spaceball_2_entry[];

struct SubScene subscene_spaceball_2 = {
    ...
    /* End Param */        NULL,
    /* Beatscript Entry */ script_spaceball_2_entry
};

struct Scene scene_spaceball_2 = {
    /* Init Func */  func_0801d86c,
    /* Init Param */ &subscene_spaceball_2,
