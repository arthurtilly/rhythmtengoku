...
/* POWER CALLIGRAPHY (BRUSH) - ANIMATIONS */
...
extern struct Animation anim_calligraphy_brush[];
extern struct Animation anim_calligraphy_brush_still[];
extern struct Animation anim_calligraphy_brush_charge1[];
extern struct Animation anim_calligraphy_brush_charge2[];
extern struct Animation anim_calligraphy_ink_dot[];
...
extern struct Animation anim_calligraphy_skip_icon[];
extern struct Animation anim_calligraphy_brush_charge_effect[];

/* POWER CALLIGRAPHY (PEOPLE) - ANIMATIONS */

extern struct Animation anim_calligraphy_people_m_dance[];
...
extern struct Animation anim_calligraphy_people_w_dance[];
