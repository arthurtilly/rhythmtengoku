...
extern struct Beatscript script_bouncy_road_entry[];

struct SubScene subscene_bouncy_road = {
    ...
    /* End Param */        NULL,
    /* Beatscript Entry */ script_bouncy_road_entry
};

struct Scene scene_bouncy_road = {
    /* Init Func */  func_0801d86c,
    /* Init Param */ &subscene_bouncy_road,
