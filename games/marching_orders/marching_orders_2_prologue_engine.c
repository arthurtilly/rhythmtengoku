...
extern Palette marching_orders_2_prologue_bg_pal[];
extern Palette marching_orders_2_prologue_obj_pal[];
...
struct CompressedGraphics *marching_orders_2_prologue_buffered_textures[] = {
