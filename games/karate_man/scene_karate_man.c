...
extern struct Beatscript script_karate_man_entry[];

struct SubScene subscene_karate_man = {
    ...
    /* End Param */        NULL,
    /* Beatscript Entry */ script_karate_man_entry
};

struct Scene scene_karate_man = {
    /* Init Func */  func_0801d86c,
    /* Init Param */ &subscene_karate_man,
