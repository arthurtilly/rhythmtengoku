...
extern struct Beatscript script_tram_pauline_entry[];

struct SubScene subscene_tram_pauline = {
    ...
    /* End Param */        NULL,
    /* Beatscript Entry */ script_tram_pauline_entry
};

struct Scene scene_tram_pauline = {
    /* Init Func */  func_0801d86c,
    /* Init Param */ &subscene_tram_pauline,
