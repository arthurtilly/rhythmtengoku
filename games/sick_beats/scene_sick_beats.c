...
extern struct Beatscript script_sick_beats_entry[];

struct SubScene subscene_sick_beats = {
    ...
    /* End Param */        NULL,
    /* Beatscript Entry */ script_sick_beats_entry
};

struct Scene scene_sick_beats = {
    /* Init Func */  func_0801d86c,
    /* Init Param */ &subscene_sick_beats,
