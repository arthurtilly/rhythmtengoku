...
extern struct Beatscript script_polyrhythm_2_entry[];

struct SubScene subscene_polyrhythm_2 = {
    ...
    /* End Param */        NULL,
    /* Beatscript Entry */ script_polyrhythm_2_entry
};

struct Scene scene_polyrhythm_2 = {
    /* Init Func */  func_0801d86c,
    /* Init Param */ &subscene_polyrhythm_2,
