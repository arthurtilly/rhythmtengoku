...
extern struct Beatscript script_polyrhythm_entry[];

struct SubScene subscene_polyrhythm = {
    ...
    /* End Param */        NULL,
    /* Beatscript Entry */ script_polyrhythm_entry
};

struct Scene scene_polyrhythm = {
    /* Init Func */  func_0801d86c,
    /* Init Param */ &subscene_polyrhythm,
