...
extern struct Beatscript script_rap_women_entry[];

struct SubScene subscene_rap_women = {
    ...
    /* End Param */        NULL,
    /* Beatscript Entry */ script_rap_women_entry
};

struct Scene scene_rap_women = {
    /* Init Func */  func_0801d86c,
    /* Init Param */ &subscene_rap_women,
