...
extern struct Beatscript script_rap_men_entry[];

struct SubScene subscene_rap_men = {
    ...
    /* End Param */        NULL,
    /* Beatscript Entry */ script_rap_men_entry
};

struct Scene scene_rap_men = {
    /* Init Func */  func_0801d86c,
    /* Init Param */ &subscene_rap_men,
