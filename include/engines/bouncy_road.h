...
#define BOUNCY_PATH_ANGLE_START (INT_TO_FIXED(2.1))
#define BOUNCY_PATH_ANGLE_END   (INT_TO_FIXED(-2.04))
...
extern void func_0802e234(void);        // Engine Event 02 (Enable Goal SFX For This Ball)
extern void func_0802e248(u32 palette); // Engine Event 04 (Set Ball Palette)
extern void func_0802e25c(s32 heightScale);  // Engine Event 05 (Set Global Bounce Height Scale)
extern void bouncy_road_get_xyzs_on_path(s24_8 angle, s32 yOfs, s32 *xReq, s32 *yReq, s32 *zReq, s24_8 *scaleReq);
