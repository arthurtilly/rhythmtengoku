...
extern struct SequenceData *mechanical_horse_player_horse_sfx[][4];
extern struct SequenceData *mechanical_horse_teacher_horse_sfx[][4];
extern struct SequenceData *mechanical_horse_lesson_bgm[];
