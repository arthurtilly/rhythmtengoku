...
// For readability.
#define gPrologueInfo ((struct Remix1PrologueInfo *)D_030055d0)
...
void func_08046668(void) {
    ...
    func_0800c604(0);
    func_08006d80();
    task = func_080087b4(get_current_mem_id(), remix_1_prologue_buffered_textures);
...
void func_08046698(u32 ver) {
    ...
    gPrologueInfo->textSprite = func_0804d160(D_03005380, anim_remix_1_prologue_title, 0, 112, 128, 0, 0, 0, 0);
}
