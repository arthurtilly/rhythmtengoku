...
// For readability.
#define gPrologueEngineData ((struct Remix8PrologueEngineData *)gCurrentEngineData)
...
void func_08046d4c(void) {
    ...
    func_0800c604(0);
    func_08006d80();
    task = start_new_texture_loader(get_current_mem_id(), remix_8_prologue_buffered_textures);
...
void remix_8_prologue_engine_start(u32 ver) {
    ...
    gPrologueEngineData->textSprite = sprite_create(D_03005380, anim_remix_8_prologue_title, 0, 112, 128, 0, 0, 0x7f, 0);
}
