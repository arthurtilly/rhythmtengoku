...
void ninja_bodyguard_prologue_engine_start(u32 ver) {
    ...
    gPrologueEngineData->textSprite = sprite_create(D_03005380, anim_ninja_bodyguard_prologue_title, 0, 120, 130, 0, 0, 0x7f, 0);
    sprite_set_anim_speed(D_03005380, gPrologueEngineData->textSprite, INT_TO_FIXED(1.5));
}
...
void func_080473a4(u32 speed) {
    sprite_set_playback(D_03005380, gPrologueEngineData->textSprite, speed, 0x7f, 0);
}
