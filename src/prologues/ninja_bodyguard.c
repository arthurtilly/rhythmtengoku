...
// For readability.
#define gPrologueEngineData ((struct NinjaBodyguardPrologueEngineData *)D_030055d0)
...
void ninja_bodyguard_prologue_engine_start(u32 ver) {
    ...
    gPrologueEngineData->textSprite = func_0804d160(D_03005380, anim_ninja_bodyguard_prologue_title, 0, 120, 130, 0, 0, 0x7f, 0);
