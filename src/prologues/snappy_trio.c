...
// For readability.
#define gPrologueEngineData ((struct SnappyTrioPrologueEngineData *)D_030055d0)
...
void snappy_trio_prologue_engine_start(u32 ver) {
    ...
    gPrologueEngineData->textSprite = func_0804d160(D_03005380, anim_snappy_trio_prologue_title, 0, 120, 100, 0, 0, 0x7f, 0);
}
