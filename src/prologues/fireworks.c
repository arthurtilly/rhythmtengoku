...
// For readability.
#define gPrologueInfo ((struct FireworksPrologueInfo *)D_030055d0)
...
void func_08045d30(void) {
    ...
    func_0800c604(0);
    func_08006d80();
    task = func_080087b4(get_current_mem_id(), fireworks_prologue_buffered_textures);
...
void func_08045d60(u32 ver) {
    ...
    gPrologueInfo->textSprite = func_0804d160(D_03005380, anim_fireworks_prologue_title, 0, 120, 8, 0, 0, 0x7f, 0);
}
