...
// For readability.
#define gPrologueEngineData ((struct Remix7PrologueEngineData *)D_030055d0)
...
void remix_7_prologue_engine_start(u32 ver) {
    ...
    gPrologueEngineData->textSprite = func_0804d160(D_03005380, anim_remix_7_prologue_title, 0, 112, 128, 0, 0, 0x7f, 0);
}
