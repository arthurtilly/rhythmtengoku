...
// For readability.
#define gPrologueInfo ((struct NightWalkPrologueInfo *)D_030055d0)
...
void func_080457f4(void) {
    ...
    func_0800c604(0);
    func_08006d80();
    task = func_080087b4(get_current_mem_id(), night_walk_prologue_buffered_textures);
...
void func_08045824(u32 ver) {
    ...
    gPrologueInfo->textSprite = func_0804d160(D_03005380, anim_night_walk_prologue_title, 0, 110, 120, 0, 0, 0x7f, 0);
    gPrologueInfo->playYanSprite = func_0804d160(D_03005380, anim_night_walk_prologue_play_yan, 0, 60, 120, 0, 0, 0x7f, 0);
    gPrologueInfo->balloonsSprite = func_0804d160(D_03005380, anim_night_walk_prologue_balloons, 0, 60, 120, 0, 1, 0, 0);
}
