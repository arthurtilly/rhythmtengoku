...
// For readability.
#define gPrologueEngineData ((struct TossBoysPrologueEngineData *)D_030055d0)
...
void toss_boys_prologue_engine_start(u32 ver) {
    ...
    gPrologueEngineData->textSprite = func_0804d160(D_03005380, anim_toss_boys_prologue_title, 0, 120, 120, 0, 0, 0, 0);
}
