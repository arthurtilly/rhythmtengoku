...
// For readability.
#define gPrologueEngineData ((struct RapMenPrologueEngineData *)D_030055d0)
...
void rap_men_prologue_engine_start(u32 ver) {
    ...
    gPrologueEngineData->textSprite = func_0804d160(D_03005380, anim_rap_men_prologue_title, 0, 190, 40, 0, 0, 0x7f, 0);
}
