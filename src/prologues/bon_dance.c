...
// For readability.
#define gPrologueEngineData ((struct BonDancePrologueEngineData *)D_030055d0)
...
void bon_dance_prologue_engine_start(u32 ver) {
    ...
    gPrologueEngineData->textSprite = func_0804d160(D_03005380, anim_bon_dance_prologue_title, 0, 80, 64, 0, 0, 0x7f, 0);
}
