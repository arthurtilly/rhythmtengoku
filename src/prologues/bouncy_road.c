...
void bouncy_road_prologue_engine_start(u32 ver) {
    ...
    gPrologueEngineData->textSprite = sprite_create(D_03005380, anim_bouncy_road_prologue_title, 0, 120, 120, 0, 0, 0x7f, 0);
    gPrologueEngineData->bouncersSprite = sprite_create(D_03005380, anim_bouncy_road_prologue_path, 0, 119, 101, 0, 0, 0x7f, 0);
}
...
void func_08045b94(u32 event) {
    switch (event) {
        case 0: // Event 0 - Play Animation (Bouncers)
            sprite_set_playback(D_03005380, gPrologueEngineData->bouncersSprite, 1, 0x7f, 0);
            break;
