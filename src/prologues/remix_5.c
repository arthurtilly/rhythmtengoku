...
// For readability.
#define gPrologueInfo ((struct Remix5PrologueInfo *)D_030055d0)
...
void func_08046a58(void) {
    ...
    func_0800c604(0);
    func_08006d80();
    task = func_080087b4(get_current_mem_id(), remix_5_prologue_buffered_textures);
...
void func_08046a88(u32 ver) {
    ...
    gPrologueInfo->textSprite = func_0804d160(D_03005380, anim_remix_5_prologue_title, 0, 112, 128, 0, 0, 0x7f, 0);
}
