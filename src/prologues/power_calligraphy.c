...
void power_calligraphy_prologue_engine_start(u32 ver) {
    ...
    gPrologueEngineData->textSprite = sprite_create(D_03005380, anim_power_calligraphy_prologue_title, 0, 160, 150, 0, 0, 0x7f, 0);
}
...
void func_080461f4(void) {
    sprite_create(D_03005380, anim_power_calligraphy_prologue_artist, 0, 120, 88, 0x800, 1, 0x7f, 0);
