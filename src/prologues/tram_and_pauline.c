...
// For readability.
#define gPrologueInfo ((struct TramPaulinePrologueInfo *)D_030055d0)
...
void tram_pauline_prologue_engine_start(u32 ver) {
    ...
    gPrologueInfo->textSprite = func_0804d160(D_03005380, anim_tram_pauline_prologue_title, 0, 120, 150, 0, 0, 0x7f, 0);
