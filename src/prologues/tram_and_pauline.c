...
// For readability.
#define gPrologueInfo ((struct TramAndPaulinePrologueInfo *)D_030055d0)
...
void tram_and_pauline_prologue_engine_start(u32 ver) {
    ...
    gPrologueInfo->textSprite = func_0804d160(D_03005380, anim_tram_and_pauline_prologue_title, 0, 120, 150, 0, 0, 0x7f, 0);
    func_0804d160(D_03005380, anim_tram_and_pauline_prologue_characters, 0, 120, 150, 0x800, 0, 0x7f, 0);
}
