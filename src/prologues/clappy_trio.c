...
// For readability.
#define gPrologueEngineData ((struct ClappyTrioPrologueEngineData *)D_030055d0)
...
void clappy_trio_prologue_engine_start(u32 ver) {
    ...
    gPrologueEngineData->textSprite = func_0804d160(D_03005380, anim_clappy_trio_prologue_title, 0, 120, 100, 0, 0, 0, 0);
}
