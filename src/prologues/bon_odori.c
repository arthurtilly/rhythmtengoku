...
// For readability.
#define gPrologueEngineData ((struct BonOdoriPrologueEngineData *)D_030055d0)
...
void bon_odori_prologue_engine_start(u32 ver) {
    ...
    gPrologueEngineData->textSprite = func_0804d160(D_03005380, anim_bon_odori_prologue_title, 0, 120, 140, 0, 0, 0x7f, 0);
}
