...
void showtime_prologue_engine_start(u32 ver) {
    ...
    gPrologueEngineData->textSprite = sprite_create(D_03005380, anim_showtime_prologue_title, 0, 64, 64, 0, 0, 0x7f, 0);
    gPrologueEngineData->penguinSprite = sprite_create(D_03005380, anim_showtime_prologue_penguin, 0, 136, 64, 0, 0, 0x7f, 0);
}
...
void func_08045a50(void) {
    ...
    sprite_set_playback(D_03005380, gPrologueEngineData->penguinSprite, 1, 0x7f, 0);
}
