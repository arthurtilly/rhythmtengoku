...
void drum_studio_start_monitor2(Palette *palette) {
    ...
    interp_col_to_pal(get_current_mem_id(), 0x40, 4, drum_lessons_bg_screen_pal[0][0], &palette[0][0], BG_PALETTE_BUFFER(0));
}
...
void drum_studio_stop_monitor1(void) {
    ...
    task = interp_pal_to_col(get_current_mem_id(), 0x20, 4, &palette[0][0], drum_lessons_bg_screen_pal[0][0], BG_PALETTE_BUFFER(0));
