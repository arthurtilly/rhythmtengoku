...
void func_08047070(void) {
    ...
    func_0800c604(0);
    task = func_08002ee0(get_current_mem_id(), prologue_rap_women_gfx_table, 0x2000);
...
void func_080470a0(void) {
    ...
    func_0800c604(0);
    func_08006d80();
    task = func_080087b4(get_current_mem_id(), prologue_rap_women_buffered_textures);
...
void func_080470d0(u32 ver) {
    ...
    gPrologueInfo->textSprite = func_0804d160(D_03005380, anim_prologue_rap_women_title, 0, 120, 120, 0, 0, 0x7f, 0);
}
