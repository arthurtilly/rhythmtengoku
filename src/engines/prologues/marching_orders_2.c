...
void func_08046340(void) {
    ...
    func_0800c604(0);
    task = func_08002ee0(func_0800c3b8(), prologue_marching_orders_2_gfx_table, 0x2000);
...
void func_08046370(void) {
    ...
    func_0800c604(0);
    func_08006d80();
    task = func_080087b4(func_0800c3b8(), prologue_marching_orders_2_buffered_textures);
