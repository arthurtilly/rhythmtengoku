...
void func_08046d1c(void) {
    ...
    func_0800c604(0);
    task = func_08002ee0(get_current_mem_id(), prologue_remix8_gfx_table, 0x2000);
...
void func_08046d4c(void) {
    ...
    func_0800c604(0);
    func_08006d80();
    task = func_080087b4(get_current_mem_id(), prologue_remix8_buffered_textures);
...
void func_08046d7c(u32 ver) {
    ...
    gPrologueInfo->textSprite = func_0804d160(D_03005380, anim_prologue_remix8_title, 0, 112, 128, 0, 0, 0x7f, 0);
}
