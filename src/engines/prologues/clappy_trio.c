...
void func_08045dfc(void) {
    ...
    func_0800c604(0);
    task = func_08002ee0(func_0800c3b8(), prologue_clappy_trio_gfx_table, 0x2000);
    task_run_after(task, func_08045dec, 0);
}
...
void func_08045e2c(void) {
    ...
    func_0800c604(0);
    func_08006d80();
    task = func_080087b4(func_0800c3b8(), prologue_clappy_trio_buffered_textures);
    task_run_after(task, func_08045dfc, 0);
}
...
void func_08045e5c(u32 ver) {
    ...
    gPrologueInfo->textSprite = func_0804d160(D_03005380, D_088afb9c, 0, 120, 100, 0, 0, 0, 0);
}
