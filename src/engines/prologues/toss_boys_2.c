#include "engines/prologues/toss_boys_2.h"
...
void func_080479e4(void) {
    ...
    func_0800c604(0);
    task = func_08002ee0(func_0800c3b8(), prologue_toss_boys_2_gfx_table, 0x2000);
    task_run_after(task, func_080479d4, 0);
}
...
void func_08047a14(void) {
    ...
    func_0800c604(0);
    func_08006d80();
    task = func_080087b4(func_0800c3b8(), prologue_toss_boys_2_buffered_textures);
    task_run_after(task, func_080479e4, 0);
}
...
void func_08047a44(u32 ver) {
    ...
    gPrologueInfo->textSprite = func_0804d160(D_03005380, D_088b8388, 0, 120, 120, 0, 0, 0x7f, 0);
}
