...
void func_08045218(void) {
    ...
    func_0800c604(0);
    task = func_08002ee0(func_0800c3b8(), prologue_spaceball_gfx_table, 0x2000);
...
void func_08045248(void) {
    ...
    func_0800c604(0);
    func_08006d80();
    task = func_080087b4(func_0800c3b8(), prologue_spaceball_buffered_textures);
...
void func_08045278(u32 ver) {
    ...
    gPrologueInfo->textSprite = func_0804d160(D_03005380, D_088ad3f4, 0, 120, 80, 0, 0, 0, 0);
}
