#include "engines/prologues/remix1.h"
...
void func_08046638(void) {
    ...
    func_0800c604(0);
    task = func_08002ee0(func_0800c3b8(), prologue_remix1_gfx_table, 0x2000);
    task_run_after(task, func_08046628, 0);
}
...
void func_08046668(void) {
    ...
    func_0800c604(0);
    func_08006d80();
    task = func_080087b4(func_0800c3b8(), prologue_remix1_buffered_textures);
    task_run_after(task, func_08046638, 0);
}
...
void func_08046698(u32 ver) {
    ...
    gPrologueInfo->textSprite = func_0804d160(D_03005380, D_088b17d0, 0, 112, 128, 0, 0, 0, 0);
}
