#include "engines/prologues/samurai_slice.h"
...
void func_08045ff4(void) {
    ...
    func_0800c604(0);
    task = func_08002ee0(func_0800c3b8(), prologue_samurai_slice_gfx_table, 0x2000);
    task_run_after(task, func_08045fe4, 0);
}
...
void func_08046024(void) {
    ...
    func_0800c604(0);
    func_08006d80();
    task = func_080087b4(func_0800c3b8(), prologue_samurai_slice_buffered_textures);
    task_run_after(task, func_08045ff4, 0);
}
...
void func_08046054(u32 ver) {
    ...
    func_0800e0a0(BG_LAYER_2, FALSE, 0, 0, 0, 30, 1);
