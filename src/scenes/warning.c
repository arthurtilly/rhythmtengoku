...
void warning_scene_render_anim(void) {
    func_0804d160(D_03005380, anim_warning_text_continue, 15, 120, 152, 0, 1, 0, 0);
}
...
void warning_scene_init_gfx3(void) {
    ...
    func_08007324(TRUE);
    task = func_08002018(0, ticks_to_frames(12), 1, 0x7FFF, warning_pal, BG_PALETTE_BUFFER(0));
