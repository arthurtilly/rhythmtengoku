...
extern void gameplay_start_scene(s32); // [func_08016ec4] Scene Start
extern void gameplay_update_paused_scene(s32); // [func_08016ffc] Scene Update (Paused)
extern void gameplay_update_scene(s32); // [func_08017000] Scene Update (Active)
...
extern void gameplay_stop_scene(s32); // [func_080177f0] Scene Stop
