...
// extern ? func_08013570(?); // [func_08013570] Graphics Init. 2
// extern ? func_0801359c(?); // [func_0801359c] Graphics Init. 1
// extern ? func_080135cc(?); // [func_080135cc] Graphics Init. 0
// extern ? func_08013644(?); // [func_08013644] Scene Init.
...
// extern ? func_08014118(?); // [func_08014118] Scene Main
